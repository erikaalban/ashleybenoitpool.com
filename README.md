# Ashley Benoit - Pool Player Website

Personal website for competitive pool player Ashley Benoit, showcasing achievements, tournament wins, and photos from the NYC pool scene.
...
- **Custom Domain**: Configured for `ashleybenoit.com`
...
- **Custom Domain**: <https://ashleybenoit.com>
- **GitHub Pages**: <https://ashleybenoit.github.io/ashleybenoit.com/>

### GitHub Pages Configuration

1. Repository: `ashleybenoit/ashleybenoit.com`
2. Branch: `main`
3. Source: `/ (root)`
4. Custom Domain: `ashleybenoit.com` (configured via CNAME)
...
The contact form uses FormSubmit.co to send emails to `ashleybenoit12@gmail.com`. No backend required!
